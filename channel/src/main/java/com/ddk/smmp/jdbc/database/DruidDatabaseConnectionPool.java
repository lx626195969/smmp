package com.ddk.smmp.jdbc.database;
...
public final class DruidDatabaseConnectionPool {
	private static final Logger LOG = Logger.getLogger(DruidDatabaseConnectionPool.class);
	
	private static DruidDataSource _dds = null;
	private static String confile = "config.properties";
