...
import com.ddk.smmp.channel.cmpp._2.msg.parent.SmsObject;

/**
 * 
 * @author leeson 2014-6-9 下午03:27:41 li_mr_ceo@163.com <br>
 * 
 */
...
public class ByteBuffer extends SmsObject {
	...
	/**
	 * everything must be checked before calling this method, and count > 0
	 * 
	 * @param bytes
	 * @param count
	 */
	...
	public void appendCString(String string) {
		try {
			appendString0(string, true, CmppConstant.ENC_ISO8859_1);
		} catch (UnsupportedEncodingException e) {
		}
	}
	...
	public void appendString(String string, int count) {
		try {
			appendString(string, count, CmppConstant.ENC_ISO8859_1);
		} catch (UnsupportedEncodingException e) {
		}
	}
	...
	public short readShort(int fromIdx)
