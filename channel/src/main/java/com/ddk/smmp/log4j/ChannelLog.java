...
public class ChannelLog {
	...
	public static void log(Logger logger, Object objLogInfo, int levelInt) {
		logger.log(new ChannelLogLevel(levelInt, "SMS", SyslogAppender.LOG_LOCAL0), objLogInfo);
	}
	...
	public static void log(Logger logger, Object objLogInfo, int levelInt, Throwable throwable) {
		logger.log(new ChannelLogLevel(levelInt, "SMS", SyslogAppender.LOG_LOCAL0), objLogInfo, throwable);
	}
}