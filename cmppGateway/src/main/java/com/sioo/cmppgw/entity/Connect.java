...
/**
 * 
 * @author leeson 2014年8月22日 上午9:19:06 li_mr_ceo@163.com <br>
 *
 */
public class Connect extends CmppHead {
	private static final long serialVersionUID = -1652154930129344762L;
	...
	public int hashCode() {
		...
		result = 31 * result
				+ (sourceAddr != null ? Arrays.hashCode(sourceAddr) : 0);
		result = 31
				* result
				+ (authenticatorSource != null ? Arrays
						.hashCode(authenticatorSource) : 0);
		result = 31 * result + (int) version;
		result = 31 * result
				+ (timeStamp != null ? Arrays.hashCode(timeStamp) : 0);
		return result;
	}
